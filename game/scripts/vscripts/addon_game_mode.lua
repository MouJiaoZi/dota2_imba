...
--[[
	...
	LinkLuaModifier("modifier_imba_ak_ability_loading", "modifier/modifier_imba_unlimited_level_powerup.lua", LUA_MODIFIER_MOTION_NONE )
	...
	LinkLuaModifier("modifier_imba_ak_ability_controller_bear", "modifier/modifier_imba_unlimited_level_powerup.lua", LUA_MODIFIER_MOTION_NONE )
	...
	LinkLuaModifier("modifier_imba_remove_self", "modifier/modifier_imba_remove_self.lua", LUA_MODIFIER_MOTION_NONE)
